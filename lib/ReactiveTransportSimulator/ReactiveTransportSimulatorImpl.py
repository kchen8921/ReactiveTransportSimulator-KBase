...
class ReactiveTransportSimulator:
    ...
    def run_batch_model(self, ctx, params):
        """
        This function enables users to run a pflotran batch model with FBA model and initial conditions as inputs
    ...
    def run_1d_model(self, ctx, params):
        """
        This function enables users to run a pflotran 1D model with FBA model and initial conditions as inputs
        :param params: instance of mapping from String to unspecified object
        :returns: instance of type "ReportResults" -> structure: parameter
           "report_name" of String, parameter "report_ref" of String
        """
